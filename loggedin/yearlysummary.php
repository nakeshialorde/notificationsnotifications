<?php
	session_start();
	if(isset($_GET["transferYear"])){
		$curl = curl_init();
		// Set some options - we are passing in a useragent too here
		curl_setopt_array($curl, array(
			CURLOPT_RETURNTRANSFER => 1,
			CURLOPT_URL => 'https://e-solutionsgroup.com:8080/api/TransferSummaryByYear?institutionId=8DB34F14-A886-4BDB-AC85-2351CDD0F715&transferYear=' . $_GET["transferYear"],
