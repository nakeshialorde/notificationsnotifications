<?php
	session_start();
	if(isset($_GET["transferDate"])){
		$curl = curl_init();
		// Set some options - we are passing in a useragent too here
		curl_setopt_array($curl, array(
			CURLOPT_RETURNTRANSFER => 1,
			CURLOPT_URL => 'https://e-solutionsgroup.com:8080/api/TransferSummaryByDate?institutionId=8DB34F14-A886-4BDB-AC85-2351CDD0F715&transferDate=' . $_GET["transferDate"],
...
<body>
	<div class="preheader">
		...
		<div id="fromDate">From: <?php echo $_GET["transferDate"]; ?></div>
		<div id="toDate">To: <?php echo $_GET["transferDate"]; ?></div>
	</div>
	<div class="header">
