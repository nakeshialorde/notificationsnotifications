;(function () {
    ...
    var api = {
        ...
        contentListDraw: function(type) {
            ...
            var div = "<div class='message-frame-header'><span style='height: 40px;line-height: 40px;text-align: center;width: 50px;    display: inline-block;'>"+ (type==1?"Message":"Notify") +"</span><button class='message-btn message-btn-blue message-btn-header' data-type='"+ type +"'>Read Notifications</button></div>"+"<div class='message-content' style='max-height:"+ (option.height?option.height+"px":"350px") +"'>";
            if (type == 1) {
         ...
         * @param mes
         */
        update: function(opt, notif, title, mes) {
